...
// Reading PIC
float *samplecam = (float *)malloc((150528) * sizeof(float)); 
...
//host buffer
float *h_result_classifier = (float *)malloc((11) * sizeof(float)); 
...
cl_mem d_result_block3_expand2, d_result_classifier_conv, d_classifier_conv_weight, d_classifier_conv_bias,d_result_classifier;
  ...
  d_sample = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_COPY_HOST_PTR, 
                       sizeof(float) * (1 * 3 * 224 * 224), samplecam, &status);
  ...
  d_result_classifier_conv = clCreateBuffer(context, CL_MEM_WRITE_ONLY, 
                       sizeof(float) * (1 * 11 * 13 * 13), NULL, &status);
  ...
  status |= clSetKernelArg(conv1x1, 2, sizeof(int), &(input_size));
  status |= clSetKernelArg(conv1x1, 3, sizeof(cl_mem), &d_result_pool1);
  status |= clSetKernelArg(conv1x1, 4, sizeof(cl_mem), &d_fire1_squeeze_weight);
  status |= clSetKernelArg(conv1x1, 5, sizeof(cl_mem), &d_fire1_squeeze_bias);
  status |= clSetKernelArg(conv1x1, 6, sizeof(cl_mem), &d_result_block1_squeeze);
  ...
  status |= clSetKernelArg(conv1x1, 1, sizeof(int), &(input_size));
  status |= clSetKernelArg(conv1x1, 2, sizeof(int), &(input_size));
  status |= clSetKernelArg(conv1x1, 3, sizeof(cl_mem), &d_result_block1_squeeze);
  status |= clSetKernelArg(conv1x1, 4, sizeof(cl_mem), &d_fire1_expand1x1_weight);
  status |= clSetKernelArg(conv1x1, 5, sizeof(cl_mem), &d_fire1_expand1x1_bias);
  status |= clSetKernelArg(conv1x1, 6, sizeof(cl_mem), &d_result_block1_expand);
  ...
  status |= clSetKernelArg(conv1x1, 1, sizeof(int), &(input_size));
  status |= clSetKernelArg(conv1x1, 2, sizeof(int), &(input_size));
  status |= clSetKernelArg(conv1x1, 3, sizeof(cl_mem), &d_result_block1_expand);
  status |= clSetKernelArg(conv1x1, 4, sizeof(cl_mem), &d_fire2_squeeze_weight);
  status |= clSetKernelArg(conv1x1, 5, sizeof(cl_mem), &d_fire2_squeeze_bias);
  status |= clSetKernelArg(conv1x1, 6, sizeof(cl_mem), &d_result_block1_squeeze);
  ...
  status |= clSetKernelArg(conv1x1, 2, sizeof(int), &(input_size));
  status |= clSetKernelArg(conv1x1, 3, sizeof(cl_mem), &d_result_block1_squeeze);
  status |= clSetKernelArg(conv1x1, 4, sizeof(cl_mem), &d_fire2_expand1x1_weight);
  status |= clSetKernelArg(conv1x1, 5, sizeof(cl_mem), &d_fire2_expand1x1_bias);
  status |= clSetKernelArg(conv1x1, 6, sizeof(cl_mem), &d_result_block1_expand);
  ...
  status |= clSetKernelArg(conv1x1, 1, sizeof(int), &(input_size));
  status |= clSetKernelArg(conv1x1, 2, sizeof(int), &(input_size));
  status |= clSetKernelArg(conv1x1, 3, sizeof(cl_mem), &d_result_pool2);
  status |= clSetKernelArg(conv1x1, 4, sizeof(cl_mem), &d_fire3_squeeze_weight);
  status |= clSetKernelArg(conv1x1, 5, sizeof(cl_mem), &d_fire3_squeeze_bias);
  status |= clSetKernelArg(conv1x1, 6, sizeof(cl_mem), &d_result_block2_squeeze);
  ...
  status |= clSetKernelArg(conv1x1, 1, sizeof(int), &(input_size));
  status |= clSetKernelArg(conv1x1, 2, sizeof(int), &(input_size));
  status |= clSetKernelArg(conv1x1, 3, sizeof(cl_mem), &d_result_block2_squeeze);
  status |= clSetKernelArg(conv1x1, 4, sizeof(cl_mem), &d_fire3_expand1x1_weight);
  status |= clSetKernelArg(conv1x1, 5, sizeof(cl_mem), &d_fire3_expand1x1_bias);
  status |= clSetKernelArg(conv1x1, 6, sizeof(cl_mem), &d_result_block2_expand);
  ...
  status |= clSetKernelArg(conv1x1, 1, sizeof(int), &(input_size));
  status |= clSetKernelArg(conv1x1, 2, sizeof(int), &(input_size));
  status |= clSetKernelArg(conv1x1, 3, sizeof(cl_mem), &d_result_block2_expand);
  status |= clSetKernelArg(conv1x1, 4, sizeof(cl_mem), &d_fire4_squeeze_weight);
  status |= clSetKernelArg(conv1x1, 5, sizeof(cl_mem), &d_fire4_squeeze_bias);
  status |= clSetKernelArg(conv1x1, 6, sizeof(cl_mem), &d_result_block2_squeeze);
  ...
  status |= clSetKernelArg(conv1x1, 2, sizeof(int), &(input_size));
  status |= clSetKernelArg(conv1x1, 3, sizeof(cl_mem), &d_result_block2_squeeze);
  status |= clSetKernelArg(conv1x1, 4, sizeof(cl_mem), &d_fire4_expand1x1_weight);
  status |= clSetKernelArg(conv1x1, 5, sizeof(cl_mem), &d_fire4_expand1x1_bias);
  status |= clSetKernelArg(conv1x1, 6, sizeof(cl_mem), &d_result_block2_expand);
  ...
  status |= clSetKernelArg(conv1x1, 1, sizeof(int), &(input_size));
  status |= clSetKernelArg(conv1x1, 2, sizeof(int), &(input_size));
  status |= clSetKernelArg(conv1x1, 3, sizeof(cl_mem), &d_result_pool3);
  status |= clSetKernelArg(conv1x1, 4, sizeof(cl_mem), &d_fire5_squeeze_weight);
  status |= clSetKernelArg(conv1x1, 5, sizeof(cl_mem), &d_fire5_squeeze_bias);
  status |= clSetKernelArg(conv1x1, 6, sizeof(cl_mem), &d_result_block3_squeeze1);
  ...
  status |= clSetKernelArg(conv1x1, 1, sizeof(int), &(input_size));
  status |= clSetKernelArg(conv1x1, 2, sizeof(int), &(input_size));
  status |= clSetKernelArg(conv1x1, 3, sizeof(cl_mem), &d_result_block3_squeeze1);
  status |= clSetKernelArg(conv1x1, 4, sizeof(cl_mem), &d_fire5_expand1x1_weight);
  status |= clSetKernelArg(conv1x1, 5, sizeof(cl_mem), &d_fire5_expand1x1_bias);
  status |= clSetKernelArg(conv1x1, 6, sizeof(cl_mem), &d_result_block3_expand1);
  ...
  status |= clSetKernelArg(conv1x1, 1, sizeof(int), &(input_size));
  status |= clSetKernelArg(conv1x1, 2, sizeof(int), &(input_size));
  status |= clSetKernelArg(conv1x1, 3, sizeof(cl_mem), &d_result_block3_expand1);
  status |= clSetKernelArg(conv1x1, 4, sizeof(cl_mem), &d_fire6_squeeze_weight);
  status |= clSetKernelArg(conv1x1, 5, sizeof(cl_mem), &d_fire6_squeeze_bias);
  status |= clSetKernelArg(conv1x1, 6, sizeof(cl_mem), &d_result_block3_squeeze1);
  ...
  status |= clSetKernelArg(conv1x1, 2, sizeof(int), &(input_size));
  status |= clSetKernelArg(conv1x1, 3, sizeof(cl_mem), &d_result_block3_squeeze1);
  status |= clSetKernelArg(conv1x1, 4, sizeof(cl_mem), &d_fire6_expand1x1_weight);
  status |= clSetKernelArg(conv1x1, 5, sizeof(cl_mem), &d_fire6_expand1x1_bias);
  status |= clSetKernelArg(conv1x1, 6, sizeof(cl_mem), &d_result_block3_expand1);
  ...
  status |= clSetKernelArg(conv1x1, 2, sizeof(int), &(input_size));
  status |= clSetKernelArg(conv1x1, 3, sizeof(cl_mem), &d_result_block3_expand1);
  status |= clSetKernelArg(conv1x1, 4, sizeof(cl_mem), &d_fire7_squeeze_weight);
  status |= clSetKernelArg(conv1x1, 5, sizeof(cl_mem), &d_fire7_squeeze_bias);
  status |= clSetKernelArg(conv1x1, 6, sizeof(cl_mem), &d_result_block3_squeeze2);
  ...
  status |= clSetKernelArg(conv1x1, 1, sizeof(int), &(input_size));
  status |= clSetKernelArg(conv1x1, 2, sizeof(int), &(input_size));
  status |= clSetKernelArg(conv1x1, 3, sizeof(cl_mem), &d_result_block3_squeeze2);
  status |= clSetKernelArg(conv1x1, 4, sizeof(cl_mem), &d_fire7_expand1x1_weight);
  status |= clSetKernelArg(conv1x1, 5, sizeof(cl_mem), &d_fire7_expand1x1_bias);
  status |= clSetKernelArg(conv1x1, 6, sizeof(cl_mem), &d_result_block3_expand2);
  ...
  status |= clSetKernelArg(conv1x1, 1, sizeof(int), &(input_size));
  status |= clSetKernelArg(conv1x1, 2, sizeof(int), &(input_size));
  status |= clSetKernelArg(conv1x1, 3, sizeof(cl_mem), &d_result_block3_expand2);
  status |= clSetKernelArg(conv1x1, 4, sizeof(cl_mem), &d_fire8_squeeze_weight);
  status |= clSetKernelArg(conv1x1, 5, sizeof(cl_mem), &d_fire8_squeeze_bias);
  status |= clSetKernelArg(conv1x1, 6, sizeof(cl_mem), &d_result_block3_squeeze2);
  ...
  status |= clSetKernelArg(conv1x1, 2, sizeof(int), &(input_size));
  status |= clSetKernelArg(conv1x1, 3, sizeof(cl_mem), &d_result_block3_squeeze2);
  status |= clSetKernelArg(conv1x1, 4, sizeof(cl_mem), &d_fire8_expand1x1_weight);
  status |= clSetKernelArg(conv1x1, 5, sizeof(cl_mem), &d_fire8_expand1x1_bias);
  status |= clSetKernelArg(conv1x1, 6, sizeof(cl_mem), &d_result_block3_expand2);
  ...
  status |= clSetKernelArg(conv1x1, 2, sizeof(int), &(input_size));
  status |= clSetKernelArg(conv1x1, 3, sizeof(cl_mem), &d_result_block3_expand2);
  status |= clSetKernelArg(conv1x1, 4, sizeof(cl_mem), &d_classifier_conv_weight);
  status |= clSetKernelArg(conv1x1, 5, sizeof(cl_mem), &d_classifier_conv_bias);
  status |= clSetKernelArg(conv1x1, 6, sizeof(cl_mem), &d_result_classifier_conv);
  ...
  input_size = 13;
  status |= clSetKernelArg(avgpool, 0, sizeof(int), &(input_size));
  status |= clSetKernelArg(avgpool, 1, sizeof(int), &(input_size));
  status |= clSetKernelArg(avgpool, 2, sizeof(cl_mem), &d_result_classifier_conv);
  status |= clSetKernelArg(avgpool, 3, sizeof(cl_mem), &d_result_classifier);
  ...
  end_time = getCurrentTimestamp();
  status = clEnqueueReadBuffer(queue, d_result_classifier, CL_TRUE, 0, sizeof(float) * 11, h_result_classifier, 0, NULL, NULL );
  ...
  ofstream myfile ("camres.txt");
  if (myfile.is_open())
  {
    for(int count = 0; count < 11; count ++){
        myfile << h_result_classifier[count] << endl ;
    }
    myfile.close();
  }
